server = function(input, output, session) {
  ...
  reactiveValsList <- list(outtab1 = reactiveVal(),
                           ...
                           upstream_catch = reactiveVal(NULL),
                           upstream_extent = reactiveVal(NULL),
                           layers_rv = reactiveValues(# Required
                                                      streams_sf = NULL, 
                                                      sa_sf = NULL,
                                                      planreg_sf = NULL,
                                                      catchments = NULL,
