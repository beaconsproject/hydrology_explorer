...
The following spatial layers are required:
  ...
  - **undisturbed areas or intactness**: This polygon layer is required if the catchment dataset does not include an attribute that describes the proportion of the catchment undisturbed. 
